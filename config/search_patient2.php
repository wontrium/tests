...
{
	echo "ไม่พบรายการที่ค้นหา : ".$_POST["txtHN"]; 
	echo ": คุณสามารถทำการสมัครข้อมูลให้ผู้ป่วยได้ จากปุ่มด้านล่าง(เพิ่มรายชื่อผู้ป่วย)nmmnmnmn "; ?>

	<form action="ff.php" name="frmAdd" method="post">
<table width=100% border="1">
  <tr>
  
    <th width="98"> <div align="center">เลขประจำตัวบุคลากร</div></th>
    <th width="198"> <div align="center">รหัสผ่าน</div></th>
    <th width="97"> <div align="center">ชื่อ - นามสกุล</div></th>
	<th width="97"> <div align="center">เบอร์โทรศัพท์</div></th>
 
   
  </tr>
  <tr>
    <td><div align="center"><input type="text" name="txtPN" size="5"></div></td>
    <td><input type="text" name="txtPassword" size="20"></td>
	<td><input type="text" name="txtName" size="20"></td>
		<td><input type="text" name="txtTel" size="20"></td>
  ...
  <input type="hidden" name="Name" value=" <?php echo $_POST["Name"]; ?> ">
  <input type="submit" name="submit" value="เพิ่มรายชื่อผู้ป่วย">
  </form>
