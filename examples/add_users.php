...
<form action="add_patient.php" name="frmAdd" method="post">
<table width=100% border="1">
  <tr>
  
    <th width="98"> <div align="center">เลขประจำตัวผู้ป่วย</div></th>
    <th width="198"> <div align="center">รหัสผ่าน</div></th>
    <th width="97"> <div align="center">ชื่อ - นามสกุล</div></th>
   
  </tr>
  <tr>
    <td><div align="center"><input type="text" name="txtHN" size="5"></div></td>
